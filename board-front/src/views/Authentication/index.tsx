...
export default function Authenticaion() {
  ...
  const SignUpCard = () => {
    ...
    const [teNumberErrorMessage, setTelNumberErrorMessage] = useState<string>('');
    //          state: 주소 에러 메세지 상태                  //
    ...
    const signUpResponse = (responseBody: SignUpResponseDto | ResponseDto | null) => {
      ...
      if (code === 'DT'){
        ...
        setTelNumberErrorMessage('이미 사용중인 전화번호입니다.');
      }
      if (code === 'VF') toast('모든 값을 입력하세요.');
      if (code === 'DBE') toast('데이터베이스 오류입니다.');
    ...
    //          event handler: 개인 정보 동의 버튼 클릭 이벤트 처리    //
    ...
    //          event handler: 회원가입 버튼 링크 클릭 이벤트 처리       //
        ...
        <div className='auth-card-box'>
          <div className='auth-card-top'>
            ...
            {page === 2 && (
              ...
              <InputBox ref={telNumberRef} label='전화번호*' type='text' placeholder='전화번호를 입력해주세요.' value={telNumber} onChange={onTelNumberChangeHandler} error={isTelNumberError} message={teNumberErrorMessage} onKeyDown={onTelNumberCheckKeyDownHandler} />
        ...
        <div className='auth-jumbotron-box'>
          <div className='auth-jumbotron-contents'>
            ...
            <div className='auth-jumbotron-text-box'>
              ...
              <div className='auth-jumbotron-text'>{'휴게소 찾기 사이트입니다.'}</div>
            </div>
          </div>
        </div>
