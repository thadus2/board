...
export default function Header() {
  ...
  const SearchButton = () => {
    ...
    return (
    <div className='icon-button' onClick={onSearchButtonClickHander}>
    ...
    return (
        <div className='header-search-input-box'>
            ...
            <div ref={searchButtonRef} className='icon-button' onClick={onSearchButtonClickHander}>
                <div className='icon search-light-icon'></div>
            </div>
        </div>
    );
  ...
  const UploadButton = () => {
    ...
    const postBoardResponse = (responseBody: PostBoardResponseDto | ResponseDto | null) => {
        ...
        if (code === 'VF') toast('제목과 내용은 필수입니다.');
        if (code !== 'SU') return;
    ...
    if (title && content) 
        return <div className='black-button' onClick={onUploadButtonClickHandler}>{`${isBoardWritePage? '업로드' : '수정'}`}</div>;
    //            render: 업로드 불가 버튼 컴포넌트 렌더링                     //
    return <div className='disable-button'>{`${isBoardWritePage? '업로드' : '수정'}`}</div>;
  }
    ...
    <div id='header'>
        <div className='header-container'>
            <div className='header-left-box' onClick={onLogoClickHandler}>
                ...
                <div className='header-logo'>{'Somyeon\'s Board'}</div>
            </div>
